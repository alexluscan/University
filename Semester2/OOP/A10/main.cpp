...
int main(int argc, char *argv[])
{
    ...
    if(csv == QMessageBox::Yes){
        UndoRedo undoredo;
        FileMovieRepo movie_repo{"University//Semester2//OOP//A10//cmake-build-debug//movies.txt"};
        CSVWatchListRepo watch_list{"University//Semester2//OOP//A10//cmake-build-debug//watchlist.txt","University//Semester2//OOP//A10//cmake-build-debug//cmake-build-debug//watch.csv"};
    ...
    UndoRedo undoredo;
        FileMovieRepo movie_repo{"University//Semester2//OOP//A10//cmake-build-debug//movies.txt"};
        HTMLWatchListRepo watch_list{"University//Semester2//OOP//A10//cmake-build-debug//watchlist.txt","University//Semester2//OOP//A10//cmake-build-debug//watch.html"};
        MovieService service{movie_repo, watch_list};
        WatchListTableModel tableView{watch_list};
        GUI gui{service, undoredo, tableView};
        gui.show();
